...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Axxess Streaming — Premium Entertainment for Less | Zambia" },
      { property: "og:description", content: "Affordable Netflix & Spotify access in Zambia. Spotify K35/mo, Netflix K70/mo, All Access K100/mo. Fast. Affordable. Reliable." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_ZM" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#000000" },
      { name: "twitter:title", content: "Axxess Streaming — Premium Entertainment for Less | Zambia" },
      { name: "twitter:description", content: "Affordable Netflix & Spotify access in Zambia. Spotify K35/mo, Netflix K70/mo, All Access K100/mo. Fast. Affordable. Reliable." },
